========================================================================
    KONSOLENANWENDUNG: MPI_Vorlage-Projektübersicht
========================================================================

Diese MPI_Vorlage-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre MPI_Vorlage-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen MPI_Vorlage.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
